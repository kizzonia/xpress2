...
class WelcomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post welcomes_url, params: { welcome: { address: @welcome.address, desc: @welcome.desc, footer: @welcome.footer, ig: @welcome.ig, link: @welcome.link, ln: @welcome.ln, logoimg: @welcome.logoimg, phone: @welcome.phone, section: @welcome.section, telegram: @welcome.telegram, title: @welcome.title, twitter: @welcome.twitter, whatsapp: @welcome.whatsapp } }
    end
