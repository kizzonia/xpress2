...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post deposits_url, params: { deposit: { amount: @deposit.amount, email: @deposit.email, payment_type: @deposit.payment_type, status: @deposit.status, user_id: @deposit.user_id } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { amount: @deposit.amount, email: @deposit.email, payment_type: @deposit.payment_type, status: @deposit.status, user_id: @deposit.user_id } }
